...
import { Film, ImageIcon, Music, Play, Plus, Replace, Trash2, Layers, Maximize2, Check, X } from "lucide-react";
...
import { setActiveDrag, writeDrag, type DragPayload } from "@/lib/editor/dnd";
...
export function AssetViewer({assets,selectedKey,onSelect,onPlace,onOverlay,onRemove,onReplace,replace,disabled,videoAction='Add to timeline',emptyMessage}:{assets:ViewerAsset[];selectedKey:string|null;onSelect:(key:string)=>void;onPlace:(asset:ViewerAsset,mode?:'music'|'sfx')=>void;onOverlay?:(asset:ViewerAsset)=>void;onRemove?:(asset:ViewerAsset)=>void;
