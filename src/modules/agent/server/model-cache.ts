...
import { WORKSPACE, ensureWorkspace } from "../../../common/server/config";
import { HARNESS_IDS, type HarnessId } from "../lib/registry";
import { curatedCatalog, mergeCatalog, CURATED, type HarnessCatalog, type ModelInfo } from "../lib/model-catalog";
import { discoverModels } from "./model-discover";
