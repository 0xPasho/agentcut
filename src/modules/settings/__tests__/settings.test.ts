 ...
 * resolves in.
 *
 * Run with: tsx --test src/modules/settings/__tests__/settings.test.ts
 */
...
let secrets: typeof import("../../../common/server/secrets");
let selection: typeof import("../../agent/server/selection");
...
let section: typeof import("../../rules/lib/preferences-section");
...
before(async () => {
  ...
  [secrets, selection, tools, registry, preferences, section, glossary, database] = await Promise.all([
    import("../../../common/server/secrets"), import("../../agent/server/selection"), import("../../editor/server/tools"),
    import("../../rules/server/registry"), import("../../rules/server/preferences"), import("../../rules/lib/preferences-section"),
    import("../../rules/server/glossary"), import("../../../common/server/db"),
  ]);
});
...
test("the picture providers report themselves configured from the saved key", async () => {
  const photos = await import("../../media/server/search/photos");
