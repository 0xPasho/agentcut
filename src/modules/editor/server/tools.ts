...
export async function executeEditorTool(projectId: string, raw: unknown, onActivity?: ToolActivity): Promise<unknown> {
  ...
  switch (call.tool) {
    ...
    case "assets.browseLocal": {
      const { browseLocalFolder } = await import("../../media/server/local-assets");
      return browseLocalFolder(call.folder, call.offset, call.limit);
    }
    case "assets.importLocal": {
      const { importLocalAsset } = await import("../../media/server/local-assets");
      return importLocalAsset(projectId, call.file);
    }
    case "assets.list": await scanLibrary(); return q.listAssets(call.kind, projectId);
    case "assets.delete": { const { removeLibraryAsset } = await import("../../media/server/assets"); return removeLibraryAsset(call.id); }
    ...
    case "assets.importFolder": {
      const { importLocalFolder } = await import("../../media/server/local-assets");
    ...
    case "templates.list": {
      const { listTemplates } = await import("../../templates/server/registry");
      return listTemplates();
    }
    case "templates.schema": {
      const { templateSchema } = await import("../../templates/server/registry");
    ...
    case "templates.save": {
      const { saveTemplate, saveTemplateFrom } = await import("../../templates/server/registry");
    ...
    case "templates.delete": {
      const { deleteTemplate } = await import("../../templates/server/registry");
    ...
    case "template.plan": {
      const { previewTemplate } = await import("../../templates/server/apply");
    ...
    case "chat.source": { const { chatSource } = await import("../../stream-comments/server/comments"); return chatSource(); }
    case "chat.setSource": { const { saveChatSource } = await import("../../stream-comments/server/comments"); return saveChatSource(call.path); }
    case "comments.list": { const { listComments } = await import("../../stream-comments/server/place"); return listComments(projectId, call, call.limit); }
    ...
    case "rules.save": { const { saveRule } = await import("../../rules/server/registry"); return saveRule(call.rule, call.level, projectId); }
    case "rules.delete": { const { deleteRule } = await import("../../rules/server/registry"); return deleteRule(call.id, call.level, projectId); }
    case "rules.evaluate": {
      const { evaluateRules } = await import("../../rules/server/evaluate");
    ...
    case "plan.generate": {
      const { generateSequencePlan, generateProjectPlan } = await import("../../plan/server/generate");
      const { effectiveSelection } = await import("../../agent/server/selection");
    ...
    case "media.transcription": {
      const { transcribeSettings } = await import("../../transcription/server/settings");
    ...
    case "observations.read": { const { readObservations } = await import("../../rules/server/observations"); return readObservations({ projectId: call.allProjects ? undefined : projectId, limit: call.limit }); }
    case "observations.review": {
      const { reviewObservations } = await import("../../rules/server/observations");
      const { effectiveSelection } = await import("../../agent/server/selection");
    ...
    case "packs.remove": { const { removePack } = await import("../../packs/server/packs"); return removePack(call.id); }
    case "packs.export": { const { exportPack } = await import("../../packs/server/packs"); const { tool, ...request } = call; void tool; return exportPack(request); }
    case "quickactions.list": { const { packQuickActions } = await import("../../packs/server/packs"); return packQuickActions(); }
    case "conversation.undo": { const { undoMessage } = await import("../../agent/server/conversation"); return undoMessage(projectId, call.messageId, call.expectedRevision); }
    case "conversation.read": { const { readConversation } = await import("../../agent/server/conversation"); return readConversation(projectId, call.limit); }
    case "glossary.get": { const { readGlossary } = await import("../../rules/server/glossary"); return readGlossary(projectId); }
    case "glossary.save": { const { saveGlossary } = await import("../../rules/server/glossary"); return saveGlossary(call.glossary, call.level, projectId); }
    case "preferences.get": { const { readPreferences } = await import("../../rules/server/preferences"); return readPreferences(projectId); }
    case "preferences.set": { const { savePreferences } = await import("../../rules/server/preferences"); return savePreferences(call.text, call.level, projectId); }
    case "onboarding.status": {
      const { onboardingState, ONBOARDING_QUESTIONS } = await import("../../onboarding/server/onboarding");
    ...
    case "onboarding.answer": { const { saveOnboardingAnswers } = await import("../../onboarding/server/onboarding"); return saveOnboardingAnswers(call.answers); }
    case "onboarding.run": {
      const { runOnboarding } = await import("../../onboarding/server/onboarding");
      const { effectiveSelection } = await import("../../agent/server/selection");
      return runOnboarding(call.answers, effectiveSelection(undefined, {}, "observations"));
    }
    case "onboarding.skip": { const { skipOnboarding } = await import("../../onboarding/server/onboarding"); return skipOnboarding(); }
    case "onboarding.reopen": { const { reopenOnboarding } = await import("../../onboarding/server/onboarding"); return reopenOnboarding(); }
    case "agents.status": {
      const { detectHarnesses } = await import("../../agent/server/detect");
      const { selectionOverview } = await import("../../agent/server/selection");
      const known = q.getProject(projectId) ? projectId : undefined;
      return { harnesses: await detectHarnesses(), ...selectionOverview(known) };
    }
    case "agents.select": {
      const { applySelection, selectionOverview } = await import("../../agent/server/selection");
    ...
    case "providerkeys.list": { const { providerKeys } = await import("../../../common/server/secrets"); return providerKeys(); }
    case "providerkeys.set": { const { setProviderKey } = await import("../../../common/server/secrets"); return setProviderKey(call.id, call.value); }
  }
}
