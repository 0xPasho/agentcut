import { DEFAULT_ITEM_TRANSFORM, type Ease, type ItemTransform, type SequenceItem, type TransformKeyframe } from "../types";
import { buildTimeMap, clipFrames } from "./timeline";

/**
 * A layer's transform over the item's own time.
 *
 * This is the other half of `src/modules/editor/types.ts`'s `TransformKeyframe`: the schema says what a
