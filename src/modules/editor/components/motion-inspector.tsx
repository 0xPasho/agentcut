...
import { Ease, type SequenceItem, type TransformKeyframe, type VideoSequence } from "@/modules/editor/types";
import type { EditorOperation } from "@/modules/editor/lib/operations";
import { sequenceFrames } from "@/modules/editor/lib/sequences";
import { itemSeconds } from "@/modules/editor/lib/keyframes";
import { EASE_LABELS, PLAYHEAD_OUTSIDE_SHOT, kenBurns, keyframeSummary, pinPlacement, pinVolume, removeKeyframe, retimeKeyframe } from "@/modules/editor/lib/motion";
import { describeAuthor, isAgentAuthor } from "@/modules/editor/lib/authorship";
import { usePlayheadSelector, usePlayheadStore } from "@/modules/editor/hooks/playhead";
