...
let history: typeof import("../src/lib/editor/history");
let registry: typeof import("../src/lib/rules/registry");
let planApply: typeof import("../src/lib/plan/apply");
let generate: typeof import("../src/lib/plan/generate");
...
before(async () => {
  ...
  [store, mediaService, tools, database, operations, history, registry, planApply, generate] = await Promise.all([
    ...
    import("../src/lib/editor/operations"), import("../src/lib/editor/history"), import("../src/lib/rules/registry"),
    import("../src/lib/plan/apply"), import("../src/lib/plan/generate"),
  ]);
...
test("applying a plan is one template application with the plan's choices, and marks the video edited", async () => {
  ...
  const result = await tools.executeEditorTool(id, { tool: "plan.apply", sequenceId, expectedRevision: revision }) as import("../src/lib/plan/apply").PlanApplyResult;
