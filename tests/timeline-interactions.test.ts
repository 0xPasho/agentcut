...
import { buildTimelineMove, buildTimelineTrim } from "../src/lib/editor/timeline-interactions";
...
before(async () => {
  ...
  [store, tools, database] = await Promise.all([import("../src/lib/editor/store"), import("../src/lib/editor/tools"), import("../src/lib/db")]);
});
