...
let binary: typeof import("../src/lib/agent/binary");
let auth: typeof import("../src/lib/agent/auth");
let catalog: typeof import("../src/lib/agent/models/catalog");
let discover: typeof import("../src/lib/agent/models/discover");
...
before(async () => {
  ...
  [binary, auth, catalog, discover, selection] = await Promise.all([
    import("../src/lib/agent/binary"),
    import("../src/lib/agent/auth"),
    import("../src/lib/agent/models/catalog"),
    import("../src/lib/agent/models/discover"),
    import("../src/lib/agent/selection"),
  ]);
});
...
test("a named harness that is not installed fails instead of falling through", async () => {
  const { resolveProvider } = await import("../src/lib/agent");
